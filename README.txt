...
윈도우 cmd 라면:
    ...
    for /L %i in (10,1,19) do curl -LO https://raw.githubusercontent.com/viviantest1004/LP-zero-2W-img-OS/image/lpzero.img.xz.%i
